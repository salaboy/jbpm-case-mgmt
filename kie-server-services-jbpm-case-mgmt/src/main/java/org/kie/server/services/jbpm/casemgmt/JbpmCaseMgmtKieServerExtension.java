package org.kie.server.services.jbpm.casemgmt;
...
public class JbpmCaseMgmtKieServerExtension implements KieServerExtension {
    ...
    public void init(KieServerImpl kieServer, KieServerRegistry registry) {
        ...
        caseInstancesService = new CaseInstancesServiceImpl();
        ((CaseInstancesServiceImpl)caseInstancesService).setProcessService(processService);
        ((CaseInstancesServiceImpl)caseInstancesService).setRuntimeDataService(runtimeDataService);
        ((CaseInstancesServiceImpl)caseInstancesService).setUserTaskService(userTaskService);
        ((CaseInstancesServiceImpl)caseInstancesService).setDeploymentService(deploymentService);
        ((CaseInstancesServiceImpl)caseInstancesService).setAdHocProcessService(null);
        ((CaseInstancesServiceImpl)caseInstancesService).setAdHocTaskService(null);
